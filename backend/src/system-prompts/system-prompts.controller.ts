...
import { SystemPromptEntity, PaginatedSystemPromptsEntity } from './entities/system-prompt.entity';
...
export class SystemPromptsController {
  ...
  @ApiResponse({ status: 201, description: 'The system prompt has been successfully created.', type: SystemPromptEntity })
  ...
  @ApiResponse({ status: 200, description: 'Return all system prompts.', type: PaginatedSystemPromptsEntity })
  ...
  @ApiResponse({ status: 200, description: 'Return the system prompt.', type: SystemPromptEntity })
  ...
  @ApiParam({ name: 'id', description: 'System Prompt ID' })
  @ApiResponse({ status: 200, description: 'The system prompt has been successfully updated.', type: SystemPromptEntity })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiResponse({ status: 404, description: 'System prompt not found.' })
  update(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', description: 'System Prompt ID' })
  @ApiResponse({ status: 204, description: 'The system prompt has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'System prompt not found.' })
